...
class CollectionViewController: UICollectionViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        fetchedResultsController = NSFetchedResultsController(fetchRequest: request, managedObjectContext: appDelegate.persistentContainer.viewContext, sectionNameKeyPath: nil, cacheName: nil) as! NSFetchedResultsController<Photo>
        do {
